...
const TranslationsContainer: React.FC<TranslationsProps> = (props) => {
  ...
  const addTranslations = (newWord: Translation) => {
    ...
    <div>
      ...
      <div className="previousTranslations">
        <TableContainer component={Paper}>
          <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
            ...
            <TableBody>
              ...
              {newTranslations.map((translation: Translation, index: number) => (
                <TableRow style={{ fontWeight: 'bold' }}
                  key={index}
                  sx={{ '&:last-child td, &:last-child th': { border: 0 } }}
                >
        ...
        <div style={{ marginTop: '50px' }}>
          <AddTranslation appId={appId} updateTranslations={addTranslations} />
        </div>
